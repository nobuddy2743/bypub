...
GDTot_Crypt = os.environ.get("CRYPT","MzdrV2VwQWpmSTcvdzllaUlrYml0MzB5S2tndnIzUW9nenU1Tk9Dalo3VT0%3D")
...
def adrino_links(url):
    ...
    if 'https://adrinolinks.com' in url or 'https://adrinolinks.in' in url:
